    ...
    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
        ...
        @foreach ($publications as $pub)
            ...
            <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                ...
                <td class="px-6 py-4">
                    <a href="/editpublications? id={{  $pub->id }}&title={{ $pub->title }}&type={{ $pub->type }}&author={{ $pub->author }}&description={{ $pub->description }}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Edit</a>
                </td>
                <td class="px-6 py-4">
