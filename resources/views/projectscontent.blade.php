                ...
                <div class="bg-white rounded-lg overflow-hidden shadow-md" style="width:50%; height:30%">
                    ...
                    <div class="p-4">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div class="col-span-1 flex justify-center items-center">
                            <a href="/editproject? id={{  $onproject->id }}&name={{ $onproject->name }}&link={{ $onproject->website }}&venue={{ $onproject->venue }}&duration={{ $onproject->duration }}&description={{ $onproject->description }}&participants={{ $onproject->participants }} ">
