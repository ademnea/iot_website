                      ...
                      <div id="carouselExampleIndicators" class="carousel slide">
                        ...
                        <div class="carousel-inner">
                              ...
                              @foreach ($event as $key => $photo)
                                ...
                                <a href="{{ asset('images/events/' . $photo->photo) }}" target="_blank">
                                  <img src="{{ asset('images/events/' . $photo->photo) }}" class="d-block" style="height:500px; width:600px;" alt="...">
                                </a>
                                </div>
                               @endforeach
                      ...
                      <h4>
                        ...
                        <br>
                            ...
                            <span class="badge bg-secondary">
                                {{ date('d-m-Y', strtotime($event[0]->start_date)) }}
                            </span>  
                            to
                             <span class="badge bg-secondary">
                                {{ date('d-m-Y', strtotime($event[0]->end_date)) }}
                            </span> 
                            </h4>
                          <br>
