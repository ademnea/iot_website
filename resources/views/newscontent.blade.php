                       ...
                       <h1>{{ $onevent->title }}</h1>
                        <p>{{ $onevent->description }}</p>
                         ...
                         <div class="grid grid-cols-2 gap-4">
                            ...
                            <div class="col-span-1 flex justify-center items-center">
                            <a href="/editnews? id={{  $onevent->id }}&description={{ $onevent->description }}&venue={{ $onevent->venue }}&link={{ $onevent->article_link }}&title={{ $onevent->title }}&startdate={{ $onevent->start_date }}&enddate={{ $onevent->end_date }}">
