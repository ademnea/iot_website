...
{{-- mission statement start --}}
    <div class ="container" id="mission">
      ...
      <div class="wow fadeInUp" data-wow-delay="0.1s">
       ...
       <hr>
            ...
            <div class="col-span-1 flex justify-center items-center">
            <a href="/edithome? id={{  $content->id }}&vision={{ $content->vision }}&motto={{ $content->motto }}&objectives={{ $content->objectives }}&mission={{ $content->mission }}">
                 <svg xmlns="http://www.w3.org/2000/svg" fill="none"  class="h-6 w-6 text-blue-500" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                 <path stroke-linecap="round" stroke-linejoin="round" d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L10.582 16.07a4.5 4.5 0 01-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 011.13-1.897l8.932-8.931zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0115.75 21H5.25A2.25 2.25 0 013 18.75V8.25A2.25 2.25 0 015.25 6H10" />
                </svg>
            </a>
   ...
   <h1 class="font-medium">Motto</h1>
    ...
    <hr>
            ...
            <div class="col-span-1 flex justify-center items-center">
            <a href="/edithome? id={{  $content->id }}&motto={{ $content->motto }}&objectives={{ $content->objectives }}&mission={{ $content->mission }}&vision={{ $content->vision }}">
                 <svg xmlns="http://www.w3.org/2000/svg" fill="none"  class="h-6 w-6 text-blue-500" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                 <path stroke-linecap="round" stroke-linejoin="round" d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L10.582 16.07a4.5 4.5 0 01-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 011.13-1.897l8.932-8.931zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0115.75 21H5.25A2.25 2.25 0 013 18.75V8.25A2.25 2.25 0 015.25 6H10" />
                </svg>
            </a>
    ...
    <h1 class="font-medium">Objectives</h1>
       ...
       <hr>
            ...
            <div class="col-span-1 flex justify-center items-center">
            <a href="/edithome? id={{  $content->id }}&motto={{ $content->motto }}&objectives={{ $content->objectives }}&vision={{ $content->vision }}&mission={{ $content->mission }}">
                 <svg xmlns="http://www.w3.org/2000/svg" fill="none"  class="h-6 w-6 text-blue-500" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                 <path stroke-linecap="round" stroke-linejoin="round" d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L10.582 16.07a4.5 4.5 0 01-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 011.13-1.897l8.932-8.931zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0115.75 21H5.25A2.25 2.25 0 013 18.75V8.25A2.25 2.25 0 015.25 6H10" />
                </svg>
            </a>
