           ...
           <form class="space-y-4 md:space-y-6" action="/editmission_route" method="post" id="form" enctype="multipart/form-data">
            ...
            <input type="hidden" value="{{ $_GET['id']}}" name="id" >
                  ...
                  <div>
                    ...
                    <input type="text" name="labname" value="{{ $_GET['labname']}}" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 light:bg-gray-700 light:border-gray-600 light:placeholder-gray-400 light:text-white light:focus:ring-green-500 light:focus:border-green-500">
                </div>
